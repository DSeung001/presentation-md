...
어울리는 상품을 추천받으며, 컬렉션을 중고로 거래할 수 있습니다.
...
1. 앱을 켜서 사진을 찍는다.
2. 사진에서 피규어 항목들이 선택되고 정보 인식
3. 나의 컬랙션으로 피규어 정보 + 전시장 규격 저장
...
5. 어울리는 상품을 추천받고, 안 쓰는 피규어는 중고로 거래한다.
...
출시 초기에는 사용자끼리 거래로 시작하지만

![이커머스](./image/e-commerce.png)


나중에는 이커머스 기능와 피규어 제작까지로 확장할 수 있습니다.
- 특정 장면을 그대로 모델링으로 바꾼 다음 직접 커스텀으로 파규어를 제작할 수 있습니다.
